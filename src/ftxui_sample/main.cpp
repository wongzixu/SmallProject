...
// configuration step. It creates a namespace called `SmallProject`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", SmallProject::cmake::project_name, SmallProject::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", SmallProject::cmake::project_version);
      return EXIT_SUCCESS;
    }
